...
To refactor a fully functioning Google Books API search engine with a RESTful API to an app that works with GraphQL API and Apollo Server. The app incorporates the MERN stack with a React front end, MongoDB database, Node.js, and Express.js.
